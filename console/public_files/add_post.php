...
<form method="post" 
 ...
 <div>
  ...
  <input type="text"  class="form-control" placeholder="Text input" id="msg_subject" name="msg_subject" value="<?php
echo htmlspecialchars($msg_subject); ?>"/><br/>
  <label for="msg_text">Post:</label>
  <textarea  class="form-control" rows="3" placeholder="Text input" id="msg_text" name="msg_text"><?php
