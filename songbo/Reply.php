...
class Reply extends YqBase {
	 ...
	 *        
	 */
	function queryAllReplyByTopic($topic_id, $user_name, $time, $maxSize = 20) {
		$state = $this->verifyUserAndWriteLog();
		if($state != 1){
			return $state;
		}
	...
	function verifyUserAndWriteLog(){
		//debug
		//return 1;
...
// echo $reply->queryAllReplyByTopic('54de228aa3136adb0700006c', 'arition', 1423845147);
