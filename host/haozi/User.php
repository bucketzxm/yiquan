...
class User extends YqBase {
	...
	function getUserByMobile($user_mobile) {
		...
		$ans ['countMyReplyByName'] = (new Reply ())->countMyReplyByName ( $ans ['user_name'] );
		...
		$ans ['countSecondFriendsByName'] = $this->countSecondFriendsByName ( $ans ['user_name'] );
		return json_encode ( $ans );
	}
...
echo $a->countFirstFriendsByName ( 'abc0' );
